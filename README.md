...
This repository contains the prototype of the approach and evaluation as described in xSemAD: Explainable Semantic Anomaly Detection in Event Logs Using Sequence-to-Sequence Models. Accepted for the 2024 International Conference on Business Process Management (BPM 2024). 
